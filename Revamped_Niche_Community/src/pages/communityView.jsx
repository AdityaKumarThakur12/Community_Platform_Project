                ...
                <div className="relative h-64">
                    ...
                    <div className="absolute inset-0 flex items-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-white w-fit">
                            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">{community.name}</h1>
                            <p className="text-sm sm:text-base md:text-lg text-gray-100">{community.description}</p>
                            <div className="flex items-center mt-4 text-gray-200 text-xs sm:text-sm md:text-base">
                        ...
                        {isMemberState ? (
                            <button
                                onClick={handleLeave}
                                className="flex items-center px-3 sm:px-4 py-2 border border-white text-white rounded-lg hover:bg-white hover:text-gray-900 transition-colors text-xs sm:text-sm md:text-base"
                            >
                            ...
                            <button
                                onClick={handleJoin}
                                className="px-4 sm:px-6 py-2 sm:py-3 bg-teal-800 text-white border rounded-lg font-medium hover:bg-gray-100 hover:text-purple-700 transition-colors text-xs sm:text-sm md:text-base"
                            >
                                Join Community
                            </button>
                        )}
