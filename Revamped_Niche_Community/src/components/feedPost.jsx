...
function FeedPost({ title, author, community, content, votes, comments }) {
  return (
    <motion.div
      ...
      className="bg-gray-900 text-white rounded-xl shadow-sm hover:shadow-md transition-shadow"
    >
      {/* Voting Section */}
      <div className="flex">
        <div className="flex flex-col items-center px-4 py-6 border-r border-gray-100">
          ...
          <span className="my-2 font-medium text-gray-300">{votes}</span>
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
        ...
        <div className="flex-1 p-6">
          <div className="flex items-center space-x-2 mb-4">
            ...
            />
            <span className="text-sm text-gray-300">Posted by {author.name}</span>
            <span className="text-sm text-gray-200">in</span>
